...
ROOT_DIRS     := . modules/records modules/health-checks
...
.PHONY: check fmt fmt-fix init validate lint test docs-version docs docs-check security lock integration-smoke integration-private-zone clean
...
integration-smoke integration-private-zone: integration-%:
